    ...
    return Scaffold(
      ...
      body: SingleChildScrollView(
        child: Column(
          children: [
            _topBanner(),
            _trackingTimeline(),   // ⭐ NEW LIVE TRACKER
            _mainCard(),
            _infoSection("Description", complaint.description, Icons.notes),
            _infoSection(
              "Location",
              "Lat: ${complaint.latitude?.toStringAsFixed(2) ?? '0.0'}, Lon: ${complaint.longitude?.toStringAsFixed(2) ?? '0.0'}",
              Icons.location_on,
            ),
    ...
    return Padding(
      ...
      child: Card(
        ...
        child: Padding(
          ...
          child: Column(
            children: [
              _detailRow(Icons.category, "Category", complaint.category),
              const SizedBox(height: 12),
              _detailRow(
